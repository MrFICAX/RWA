...
export class PlayersService {
  ...
  getPlayers() {
    return this.httpClient
      .get<Player[]>(environment.apiUrl + '/club')
  ...
  public createPlayer(player: Player) {
    return this.httpClient.post<Player>(
      `${environment.apiUrl}/players/create`,
      player
    );
  }
  ...
  public updatePlayer(player: Player) {
    return this.httpClient.put<Player>(
      `${environment.apiUrl}/players/${player.id}/update`,
      player
    );
  }
  ...
  public getStadium() {
    return this.httpClient
      .get<Stadium>(environment.apiUrl + '/stadium')
      .pipe(catchError(errorHandler));
  }

  public updateLikes(playerId: number, LikesValue: number) {
    return this.httpClient.put<Player>(
      `${environment.apiUrl}/players/${playerId}/updateLikes`,
      LikesValue
    );
  }

  public updateDislikes(playerId: number, DislikesValue: number) {
    return this.httpClient.put<Player>(
      `${environment.apiUrl}/players/${playerId}/updateDislikes`,
      DislikesValue
    );
  }
}
